...
import dagshub
dagshub.init(repo_owner='ebid.py', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        self.track_mlflow(best_model,classification_train_metric,f"{best_model_name}_train")


        y_test_pred=best_model.predict(x_test)
        classification_test_metric=get_classification_score(y_true=y_test,y_pred=y_test_pred)

        self.track_mlflow(best_model,classification_test_metric,f"{best_model_name}_test")
